...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-muted/20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          >
            Ready for a site
            <br />
            <span className="text-muted-foreground/50">people actually trust?</span>
          </motion.h2>
        ...
        <AnimatePresence mode="wait">
          {formState === "success" ? (
            <motion.div
              ...
              className="flex flex-col items-center justify-center min-h-[450px] p-8 rounded-2xl border border-border bg-card/50 text-center"
            >
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-background border border-border rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-foreground/30 focus:ring-2 focus:ring-foreground/5 transition-all"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-background border border-border rounded-xl text-foreground focus:outline-none focus:border-foreground/30 focus:ring-2 focus:ring-foreground/5 transition-all appearance-none cursor-pointer"
                  >
              ...
              <div className="mb-6 space-y-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 bg-background border border-border rounded-xl text-foreground placeholder-muted-foreground focus:outline-none focus:border-foreground/30 focus:ring-2 focus:ring-foreground/5 transition-all resize-none"
