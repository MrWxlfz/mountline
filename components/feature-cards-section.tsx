      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 lg:mb-20">
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground/60">presence needs.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="grid grid-cols-12 gap-4 lg:gap-8 items-start lg:items-center">
                ...
                <div className="col-span-2 lg:col-span-1">
                  <motion.span 
                    className="text-sm font-mono text-muted-foreground/60 group-hover:text-muted-foreground transition-colors"
                    initial={{ opacity: 0 }}
                ...
                <div className="col-span-12 lg:col-span-5 lg:col-start-5">
                  <p className="text-muted-foreground leading-relaxed mt-4 lg:mt-0">
                    {service.description}
                  </p>
                </div>
                ...
                <div className="col-span-12 lg:col-span-3 flex flex-wrap gap-2 mt-4 lg:mt-0 lg:justify-end">
                  {service.features.map((feature) => (
                    <span 
                      key={feature}
                      className="px-2.5 py-1 text-[10px] text-muted-foreground bg-muted rounded-full uppercase tracking-wider font-medium"
                    >
                      {feature}
                    </span>
                  ))}
