              ...
              <div className={`h-full rounded-2xl border transition-all duration-300 ${
                ...
                {plan.badge && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-background text-foreground text-[10px] font-medium uppercase tracking-wider border border-border">
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    ...
                    <div className={`text-[10px] uppercase tracking-wider mt-1 ${
                      plan.highlight ? "text-background/50" : "text-muted-foreground/70"
                    }`}>
                      {plan.priceNote}
                    </div>
                  </div>
                    ...
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3">
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5 ${
                          plan.highlight ? "bg-background/10" : "bg-muted"
                        }`}>
                  ...
                  <motion.button
                    ...
                    className={`w-full flex items-center justify-center gap-2 py-3.5 rounded-xl text-sm font-medium transition-all ${
                      plan.highlight
                        ...
                        : "bg-muted hover:bg-foreground/5 text-foreground border border-border hover:border-foreground/20"
                    }`}
                  >
                    Get started
