...
const conceptBuilds: ConceptBuild[] = [
  ...
  },
  {
    ...
    colorAccent: "bg-stone-500",
    href: "/work/contractor",
    mockContent: {
      nav: "RIDGEWAY",
      headline: "Reliable Home Projects",
      cta: "Estimate",
    },
  },
  {
  ...
  },
  {
    title: "Beauty Studio",
    category: "Full Website",
    description: "Service menu, booking path, gallery-style preview, and appointment request flow for a beauty studio.",
    tags: ["4 pages", "Booking", "Services"],
    colorAccent: "bg-rose-300",
    href: "/work/beauty-studio",
    mockContent: {
      nav: "VALE STUDIO",
      headline: "Sharper Booking",
      cta: "Book",
    },
  },
]
    ...
    <section id="work" className="py-24 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 lg:mb-20">
          ...
          >
            Sample directions that show the kind of online presence Mountline can create.
          </motion.p>
        </div>
